...
class MainActivity : AppCompatActivity() {
    enum class HistoricalFigures(val age: Int, val description: String, val person: String) {
        ...
        Figure_6(62, "Leonardo da Vinci was an Italian polymath of the Renaissance, known for his contributions to art, science, and engineering.", "Leonardo da Vinci"),
        ...
        Figure_10(47, "Amelia Earhart was an aviation pioneer and the first female aviator to fly solo across the Atlantic Ocean.", "Amelia Earhart"),
        ...
        Figure_16(52, "Ludwig van Beethoven was a German composer and pianist. A crucial figure in the transition between the Classical and Romantic eras in classical music, he remains one of the most recognized and influential musicians of this period.", "Ludwig van Beethoven"),
        ...
        Figure_18(21, "Ansu Fati is a professional soccer player.","Ansu Fati"),
        Figure_19(25, "Mr Beast is a well known Youtube Star with over a million susbsribers.","Mr Beast"),
        Figure_20(29, "Mr Beast is a well known Youtube Star with over a million susbsribers.","Logan Paul"),
        Figure_21(43, "Kim Kardashian is a well known reality star.","Kim Kardashian "),
    }
